...
int hmi_packet_file(hmi_page_t *page, const char *rootpath)
{
	...
	// 9.write json data
	// memset(filename, 0, sizeof(filename));
	// sprintf(filename, "%s/img/data.json", rootpath);
	// printf("Writing JOSN %s", filename);

	// fp_data_json = fopen(filename, "rb");
	// if (!fp_data_json)
	// {
	// 	printf("file open error %s.\n", filename);
	// 	return -1;
	...
	// fseek(fp_data_json, 0L, SEEK_END);
	// file_size = ftell(fp_data_json);
	// fseek(fp_data_json, 0L, SEEK_SET);
	...
	// fread(p_buff, file_size, 1, fp_data_json);
	// if (fp_data_json)
	// {
	// 	fclose(fp_data_json);
	// 	fp_data_json = NULL;
	...
	// 	elem = slist_entry(node, hmi_element_t, elem_l_tail);
	// 	if(elem){
	// 		printf("\nJSON:: obj_id: %d--obj_data: %s\n", elem->elem_attr.obj_id, elem->elem_attr.obj_data);
	// 	}
	// }
	...
	// 		cJSON_AddNumberToObject(jsonObj, "obj_id", elem->elem_attr.obj_id);
	// 		cJSON_AddStringToObject(jsonObj, "obj_data", elem->elem_attr.obj_data);
	// 		// 添加其他字段...
	...
	// FILE *file = fopen("H:/hid-handle/ddd.json", "w");
	// if (file)
	// {
	...
	// free(jsonString);		 // 释放 JSON 字符串的内存
...
int hmi_unpacket_file(const char *filepath, const char *out_path)
{
	...
	unsigned int font_elem_num = 0;
	unsigned int progress_file_elem_num = 0;
	unsigned int json_data_elem_num = 0;
	...
	// 		cJSON *jsonObj = cJSON_CreateObject();
	// 		cJSON_AddNumberToObject(jsonObj, "obj_id", elem_attr.obj_id);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_type", elem_attr.obj_type);
	// 		cJSON_AddStringToObject(jsonObj, "obj_name", elem_attr.obj_name);
	// 		cJSON_AddStringToObject(jsonObj, "obj_wifi_name", elem_attr.obj_wifi_name);
	// 		cJSON_AddStringToObject(jsonObj, "obj_wifi_pass", elem_attr.obj_wifi_pass);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_x", elem_attr.obj_x);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_y", elem_attr.obj_y);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_w", elem_attr.obj_w);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_h", elem_attr.obj_h);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_opa", elem_attr.obj_opa);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_r", elem_attr.obj_r);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_g", elem_attr.obj_g);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_b", elem_attr.obj_b);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_opa_2", elem_attr.obj_opa_2);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_r_2", elem_attr.obj_r_2);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_g_2", elem_attr.obj_g_2);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_b_2", elem_attr.obj_b_2);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_opa_3", elem_attr.obj_opa_3);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_r_3", elem_attr.obj_r_3);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_g_3", elem_attr.obj_g_2);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_b_3", elem_attr.obj_b_3);

	// 		cJSON_AddStringToObject(jsonObj, "obj_font_name", elem_attr.obj_font_name);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_font_size", elem_attr.obj_font_size);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_font_r", elem_attr.obj_font_r);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_font_g", elem_attr.obj_font_g);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_font_b", elem_attr.obj_font_b);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_val_flag", elem_attr.obj_val_flag);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_is_stock", elem_attr.obj_is_stock);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_rise_r", elem_attr.obj_rise_r);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_rise_g", elem_attr.obj_rise_g);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_rise_b", elem_attr.obj_rise_b);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_fall_r", elem_attr.obj_fall_r);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_fall_g", elem_attr.obj_fall_g);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_fall_b", elem_attr.obj_fall_b);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_range_min", elem_attr.obj_range_min);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_range_max", elem_attr.obj_range_max);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_angle_range", elem_attr.obj_angle_range);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_rotation", elem_attr.obj_rotation);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_width", elem_attr.obj_width);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_progress_interval", elem_attr.obj_progress_interval);

	// 		// cJSON_AddStringToObject(jsonObj, "obj_progress_name", elem_attr.obj_progress_name);
	// 		const char *progressName = elem_attr.obj_progress_name[0];
	// 		cJSON_AddStringToObject(jsonObj, "progress_name", progressName);

	// 		// cJSON_AddStringToObject(jsonObj, "obj_rule_name", elem_attr.obj_rule_name);
	// 		const char *obj_rule_name = elem_attr.obj_rule_name[0];
	// 		cJSON_AddStringToObject(jsonObj, "obj_rule_name", obj_rule_name);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_point_x_num", elem_attr.obj_point_x_num);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_point_y_num", elem_attr.obj_point_y_num);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_time", elem_attr.obj_time);

	// 		// const int *obj_var = elem_attr.obj_var[0];
	// 		// double obj_var = static_cast<double>(elem_attr.obj_var[0]);
	// 		// cJSON_AddNumberToObject(jsonObj, "obj_var", obj_var);
	// 		// cJSON_AddNumberToObject(jsonObj, "obj_var", elem_attr.obj_var);

	// 		cJSON_AddNumberToObject(jsonObj, "obj_event", elem_attr.obj_event);
	// 		cJSON_AddNumberToObject(jsonObj, "obj_action", elem_attr.obj_action);

	// 		cJSON_AddStringToObject(jsonObj, "obj_data", elem_attr.obj_data);
	// 		cJSON_AddStringToObject(jsonObj, "obj_url", elem_attr.obj_url);
	// 		cJSON_AddStringToObject(jsonObj, "obj_field", elem_attr.obj_field);
	// 		cJSON_AddStringToObject(jsonObj, "obj_reserve", elem_attr.obj_reserve);
	// 		// double obj_font = static_cast<double>(elem_attr.obj_font[0]);
	// 		// cJSON_AddNumberToObject(jsonObj, "obj_font", obj_font);

	// 		cJSON_AddStringToObject(jsonObj, "obj_align_reserve", elem_attr.obj_align_reserve);
